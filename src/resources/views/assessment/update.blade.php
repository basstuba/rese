...
@section('css')
<link rel="stylesheet" href="{{ asset('css/assessment_update.css') }}"/>
                    ...
                    <div class="favorite">
                        @if($shop->favorites->isEmpty())
                            <form class="favorite-form" action="/favorite" method="post">
                                ...
                                <button class="form-button" type="submit" name="update">
                        ...
                        @else
                            <form class="favorite-form__delete" action="/favorite/delete" method="post">
                                ...
                                @csrf
                                <input type="hidden" name="shop_id" value="{{ $shop['id'] }}"/>
                                <button class="form-button" type="submit" name="updatePage">
    ...
    <div class="assessment">
        <form class="assessment-form" action="/assessment/update" method="post" enctype="multipart/form-data">
            ...
            <div class="assessment-comment">
                ...
                placeholder="{{ old('assessment_comment') || $userAssessment['assessment_comment'] ? '' : 'コメントをご記入ください' }}">{{ old('assessment_comment') ?? $userAssessment['assessment_comment'] }}</textarea>
            ...
            <div class="assessment-button">
                <input type="hidden" name="assessment_id" value="{{ $userAssessment['id'] }}">
                <input type="hidden" name="shop_id" value="{{ $shop['id'] }}">

...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_url' => 'storage/image/sushi.jpg'
        ];
        ...
        $param = [
            ...
            'img_url' => 'storage/image/yakiniku.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img_url' => 'storage/image/izakaya.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img_url' => 'storage/image/italian.jpg'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img_url' => 'storage/image/ramen.jpg'
        ];
        DB::table('shops')->insert($param);
